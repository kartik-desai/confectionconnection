      ...
      <div class="row">
        <div class="col-lg-3">
          ...
          <div class="list-group">
            ...
            <a href="cupcakes.php" class="list-group-item"><div>Cupcakes</div><div style="text-align: right;margin-top: -25px;">></div></a>
        ...
        <div class="col-lg-9">
          <div class="row" style="margin-top: 50px;">
            <?php
              $sql3="select * from CakeData where Item in('Cupcake');";
